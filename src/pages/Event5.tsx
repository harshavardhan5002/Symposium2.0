  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-16">
      ...
      <section className="grid md:grid-cols-2 gap-8">
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-teal-green-100">Tournament Games</h2>
      ...
      {/* Tournament Format */}
      <section>
        <h2 className="text-3xl font-bold mb-8 text-teal-green-100">Tournament Format</h2>
