  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-16">
        ...
        <div className="relative z-10 py-24 px-6 md:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mb-8">
              Present your research and innovative ideas in front of industry experts and academia.
            </p>
            <Link
              to="/register"
      ...
      <section className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="grid gap-6">
            {[
              ...
              { icon: <Clock className="h-6 w-6" />, text: "9:00 AM - 5:00 PM" },
              { icon: <MapPin className="h-6 w-6" />, text: "Conference Hall" },
              { icon: <Users className="h-6 w-6" />, text: "Individual or Team of 2" },
              { icon: <Trophy className="h-6 w-6" />, text: "Prizes worth ₹50,000" }
            ].map((item, index) => (
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-teal-green-100">Research Domains</h2>
      ...
      {/* Guidelines */}
      <section>
        <h2 className="text-3xl font-bold mb-8 text-teal-green-100">Presentation Guidelines</h2>
