...
const Event3 = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 space-y-16">
        ...
        <div className="relative z-10 py-24 px-6 md:px-12">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-2xl mb-8">
              Design, build, and compete with your robot in various challenging tasks.
            </p>
            <Link
              to="/register"
      ...
      <section className="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <div className="grid gap-6">
            {[
              { icon: <Calendar className="h-6 w-6" />, text: "March 16, 2024" },
              { icon: <Clock className="h-6 w-6" />, text: "10:00 AM - 6:00 PM" },
              { icon: <MapPin className="h-6 w-6" />, text: "Robotics Lab" },
              { icon: <Users className="h-6 w-6" />, text: "Teams of 3-4 members" },
              { icon: <Trophy className="h-6 w-6" />, text: "Prizes worth ₹75,000" }
            ].map((item, index) => (
        ...
        >
          <h2 className="text-2xl font-bold mb-4 text-teal-green-100">Challenge Rounds</h2>
      ...
      <section>
        <h2 className="text-3xl font-bold mb-8 text-teal-green-100">Robot Specifications</h2>
        <div className="grid md:grid-cols-2 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-gray-800/50 p-6 rounded-xl backdrop-blur-sm"
            >
              <h3 className="text-xl font-bold mb-4 text-teal-green-400">{section.title}</h3>
              <ul className="space-y-3">
                {section.items.map((item, itemIndex) => (
                  <li key={itemIndex} className="flex items-center space-x-3">
                    <div className="h-2 w-2 bg-teal-green-500 rounded-full" />
